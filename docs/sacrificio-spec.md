...
dissecação é por **órgão**: fígado, rim, pâncreas, cérebro → (córtex + cerebelo),
...
- `dissecacao_cerebro` → subdividido: `dissecacao_cortex`, `separacao_cortex_cerebelo`
- `homogeneizacao`
...
5. **Órgãos dissecáveis:** fígado, rim, pâncreas, córtex, cerebelo, sangue
